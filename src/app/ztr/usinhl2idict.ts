export const usinhl2idict: {
    ...
    /////[ɦꟈđꞇćṅᴀ]ɦćԃďńàᴀ	
      all_phoniks_list: [
        ...
        '', // 	dcd=null
        '', // 	dce=null
        'Aa', // dcf= sinhala vowel sign aa
        'Ae', // dd0= sinhala vowel sign ae
        'Aa', // 	dd1= sinhala vowel sign aae
        'Ai', // 	dd2= sinhala vowel sign i
        'Ai', // 	dd3= sinhala vowel sign ii
        'Au', // dd4= sinhala vowel sign u
        '', // dd5=null
        'Au', // dd6= sinhala vowel sign uu
        '', // dd7=null
